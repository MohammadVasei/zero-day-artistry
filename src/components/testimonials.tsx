...
const FALLBACK_QUOTES = [
  {
    quote:
      "ZeroDayTeam rebuilt our entire orchestration layer in 11 weeks. We've eliminated 100% of manual entry errors since launch.",
    name: "Daniel Reed",
        ...
        {quotes.map((q, i) => (
          <ScrollReveal key={q.name} delay={i * 120}>
            <figure className="glass-card rounded-3xl p-8 relative h-full">
              <span className="text-display text-8xl text-neon/[0.15] absolute top-4 right-6 leading-none select-none">
                &ldquo;
              </span>
