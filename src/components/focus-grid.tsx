...
const cards = [
  {
    ...
    body: "Stack audits across legacy and modern systems to map every bridge needed.",
  },
  {
    icon: Layers,
    title: "Full-Stack Engineering",
    body: "From Valhalla routing engines to Spring Boot APIs — end-to-end delivery.",
  },
  {
    icon: Code2,
    title: "Middleware Mastery",
    body: "Custom orchestration layers that eliminate manual errors at scale.",
  },
  {
    icon: ShieldCheck,
    title: "Global Deployment",
    body: "EU-localized, resilient, zero-downtime launches across all regions.",
  },
];
